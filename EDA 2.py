...
# Load your dataset
df = pd.read_csv('Titanic-Dataset.csv')  # Replace with your actual file name
...
fig = px.box(df, y="Pclass")  # Replace "Age" with any numeric column you want
fig.show()

# Example inference
print("The feature 'Age' is right-skewed with a few outliers above 80 years.")
